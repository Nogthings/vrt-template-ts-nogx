...
function Home() {
  return (
    <div className="h-screen">
      <main>
        <h1 className="text-gray-700 dark:text-gray-200 font-semibold text-lg text-center">Nogx Template</h1>
        <p className="text-gray-500 dark:text-gray-400 text-center">Una plantilla Vite + React</p>
